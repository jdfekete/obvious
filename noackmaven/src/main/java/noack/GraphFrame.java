...
public class GraphFrame extends JFrame {
  ...
  final GraphCanvas canvas;
	...
	public GraphFrame(Map<Node,double[]> nodeToPosition, Map<Node,Integer> nodeToCluster) {
        ...
        canvas = new GraphCanvas(nodeToPosition, nodeToCluster);
...
class GraphCanvas extends JComponent {
    ...
    public void setPositionAndCluster(Map<Node, double[]> position, Map<Node, Integer> cluster) {
      this.nodeToPosition = position;

...
public class Graph {
  ...
  /**
   * Begins a massive edit.
   */
  public void beginEdit() {
    for (GraphListener listnr : this.getGraphListeners()) {
      listnr.beginEdit();
    }
  }

  /**
   * Finishes a massive edit.
   */
  public void endEdit() {
    for (GraphListener listnr : this.getGraphListeners()) {
      listnr.endEdit();
   ...
   */
  public Collection<GraphListener> getGraphListeners() {
    return listener;
  }
   ...
   */
  public void addGraphListener(GraphListener listnr) {
    listener.add(listnr);
  }
   ...
   */
  public void removeGraphListener(GraphListener listnr) {
   ...
   */
  public void fireGraphEvent(String source, String target, int type) {
    if (this.getGraphListeners().isEmpty()) {
      return;
    }
    for (GraphListener listnr : this.getGraphListeners()) {

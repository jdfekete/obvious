...
public final class ScatterplotTwoView {
  ...
  public static void main(final String[] args) throws ObviousException {
    ...
    editPane.add(new JButton("-"), 1);
    editPane.add(new JButton("refresh"), 2);
    JSplitPane tableViewPane = new JSplitPane(JSplitPane.VERTICAL_SPLIT);
    tableViewPane.add(scrollpane, 0);
    tableViewPane.add(editPane, 1);

...
have flourished in various languages such as Java~\cite{InfoVis,
  Prefuse, jung2003, Improvise} or JavaScript~\cite{flare,thejit,Protovis}
to name a few.  When starting a Visual Analytics project, the choice
of the toolkit is a major initial decision and this proliferation of
...
VizTree~\cite{lin01}, a visual analytics application for monitoring
...
we describe the design of Obvious. Section 3 reports on the wrapping
of several toolkits and components with Obvious. Section 4 shows
examples of Obvious in action to assess its usefulness. Section 5

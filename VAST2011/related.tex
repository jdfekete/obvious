...
transforms the data into a \emph{polylithic} graphic structure
...
being aware of alternatives.  Combining the best possible features
...
Unicode Consortium or OMG), and consortia of public or private
...
international industry consortium of companies, government agencies
...
At the other extreme are the application domains where one system
becomes the standard.  For example, in Scientific Visualization,
VTK~\cite{VTK} has become, in the latest years, the standard toolkit:
it is used by researchers and practitioners, and newer solutions are
getting integrated quickly into VTK.  This is possible when a either a
